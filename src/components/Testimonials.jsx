              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <CardContent className="p-10 pt-14 flex flex-col h-full">
                      {/* Feedback Text */}
                      <Typography
                        variant="body1"
                        sx={{
